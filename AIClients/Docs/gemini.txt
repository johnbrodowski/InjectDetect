...
| `reasoning_effort` (OpenAI) | `thinking_level` (Gemini 3.1 Pro) | `thinking_level` (Gemini 3 Pro) | `thinking_level` (Gemini 3 Flash) | `thinking_budget` (Gemini 2.5) |
| `reasoning_effort` (OpenAI) | `thinking_level` (Gemini 3.1 Pro) | `thinking_level` (Gemini 3 Pro) | `thinking_level` (Gemini 3 Flash) | `thinking_budget` (Gemini 2.5) |
|---|---|---|---|---|
| `minimal` | `low` | `low` | `minimal` | `1,024` |
| `low` | `low` | `low` | `low` | `1,024` |
| `medium` | `medium` | `ERROR, not supported` | `medium` | `8,192` |
